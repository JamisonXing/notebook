...
create user jamison@'%' identified by 'xxj753896';
GRANT ALL PRIVILEGES ON *.* TO 'jamison'@'%'WITH GRANT OPTION;
flush privileges;
```
...
change master to master_host='47.120.7.191',master_user='jamison',master_password='xxj753896',master_log_file='mysql-bin.000001',master_log_pos=878;
